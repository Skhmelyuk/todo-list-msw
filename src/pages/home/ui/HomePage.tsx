  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-6 bg-zinc-50 text-zinc-900">
      <div className="max-w-md w-full bg-white border border-zinc-200 rounded-3xl p-8 shadow-xs text-center">
        <span className="inline-block px-3 py-1 text-xs font-semibold text-emerald-600 bg-emerald-50 rounded-full border border-emerald-200/50 mb-4">FSD Architecture + shadcn/ui</span>
        <h1 className="text-3xl font-black tracking-tight text-zinc-900">todo-list-msw</h1>
        <p className="mt-3 text-sm text-zinc-500">Проект успішно ініціалізовано без App.tsx з React Router (Data Mode) та shadcn/ui за FSD архітектурою!</p>
